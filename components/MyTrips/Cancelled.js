...
export default function Cancelled() {
    return (
        <ScrollView>
            ...
            <View style={{ width: 1000, backgroundColor: "#F6F8FC", height: 750 }}>
                ...
                <View style={{ marginTop: 25, flexDirection: "column", marginLeft: 30 }}>
                    ...
                    <View style={{ flexDirection: "row", marginTop: 10 }}>
                        <Text style={{ color: "grey" }}>Tue, July 18</Text>
                    </View>
                    ...
                    <View style={{ width: 390, height: 50, borderWidth: 1, flexDirection: "column", backgroundColor: "white", borderRightColor: "lightgrey", borderLeftColor: "lightgrey", borderBottomColor: "white", borderTopColor: "#E4EDFA" }}>
                        <View style={{ flexDirection: "row", marginTop: 15, marginLeft: 17 }}>
                            <Text style={{ color: "black", fontSize: 13 }}>ID: 86766545432</Text>
                            <View style={{ backgroundColor: "#EDF0FA", height: 20, width: 70, alignItems: "center", marginLeft: 185 }}>
                                <Text style={{ fontSize: 11, color: "black" }}>Cancelled</Text>
                            </View>
                        </View>
                    </View>
                    ...
                    <View style={{ width: 390, height: 80, borderWidth: 1, flexDirection: "column", backgroundColor: "white", borderRightColor: "lightgrey", borderLeftColor: "lightgrey", borderBottomColor: "lightgrey", borderTopColor: "lightgrey" }}>
                        <View style={{ flexDirection: "row" }}>
                            <View style={{ flexDirection: "column" }}>
                                <Image style={{ height: 80, width: 60 }} source={require("../../assets/Inter.jpg")} />
                            </View>
                            <View style={{ flexDirection: "column", marginLeft: 20, marginTop: 10 }}>
                                <Text style={{ color: "black", fontSize: 15 }}>InterContinental Bangkok Sukhumvit</Text>
                                <View style={{ flexDirection: "row" }}>
                                    <View style={{ flexDirection: "column" }}>
                                        <Text style={{ color: "grey", fontSize: 11 }}>Check in</Text>
                                        <Text style={{ color: "black", fontSize: 11 }}>Tue,  July 18</Text>

                                    </View>
                                    <View style={{ flexDirection: "column", marginLeft: 20 }}>
                                        <Text style={{ color: "grey", fontSize: 11 }}>Check out</Text>
                                        <Text style={{ color: "black", fontSize: 11 }}>Tue,  July 25</Text>
                                    </View>
                                </View>
                            </View>
                        </View>
                    ...
                    <View style={{ width: 390, height: 70, borderBottomRightRadius: 15, borderBottomLeftRadius: 15, borderWidth: 1, flexDirection: "column", backgroundColor: "white", borderBottomColor: "lightgrey", borderTopColor: "white", borderRightColor: "lightgrey", borderLeftColor: "lightgrey", justifyContent: "center" }}>
                        <View style={{ flexDirection: "row", borderRadius: 20, marginLeft: 17 }}>
                            <TouchableOpacity
                                style={{
                    ...
                    <View style={{ marginTop: 15, borderRadius: 15, height: 70, width: 390, borderColor: "lightgray", borderWidth: 1, flexDirection: "column", justifyContent: "center" }}>
                        <View style={{ flexDirection: "row" }}>
                            <View style={{ flexDirection: "column", marginLeft: 15, borderWidth: 0.7, height: 15, width: 15, borderRadius: 30, borderColor: "grey", alignItems: "center", marginTop: 3 }}>
                                <FontAwesome name="info" size={10} color="grey" style={{ marginTop: 1 }} />
                            </View>
                            <View style={{ flexDirection: "column", marginLeft: 10 }}>
                                <Text style={{ fontSize: 13, color: "grey" }}>Looking for bookings older than 18 months?</Text>
                                <TouchableOpacity>
                                    <Text style={{ fontSize: 13, color: "#437CE9", marginTop: 5 }}>View bookings</Text>
                                </TouchableOpacity>
                            </View>
